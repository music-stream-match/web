...
export const DEEZER_CONFIG = {
  ...
  redirectUri: import.meta.env.MODE === 'production'
    ...
    : 'https://localhost-vite.mobulum.xyz/web/callback/deezer',
...
export const TIDAL_CONFIG = {
  ...
  redirectUri: import.meta.env.MODE === 'production'
    ...
    : 'https://localhost-vite.mobulum.xyz/web/callback/tidal',
...
export const SPOTIFY_CONFIG = {
  ...
  redirectUri: import.meta.env.MODE === 'production'
    ...
    : 'https://localhost-vite.mobulum.xyz/web/callback/spotify',
